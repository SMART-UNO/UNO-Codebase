...
test_trained_agents(random_agent, sarsa_agent, 10000)
test_trained_agents(sarsa_agent, random_agent, 10000)
# test_trained_agents(random_agent, random_agent, 10000)
